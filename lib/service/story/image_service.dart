...
class ImageService {
  Future<Uint8List> generateImage({
    ...
    try {
      final prompt =
          "A colorful cartoon-style illustration for a children's book. Setting: $place, Character: $character, Event: $event, Story title: $title";
      var request =
          http.MultipartRequest('POST', Uri.parse(Environment.vyroApiUrl));
