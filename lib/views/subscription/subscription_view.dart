...
//       List<ProductDetails> products = await _getProducts(productIds: {_premiumUnlock});
//       if (products.isEmpty) {
//         setState(() {
//           _errorMessage = 'Ürün bilgileri alınamadı. Lütfen daha sonra tekrar deneyin.';
//           _loading = false;
...
//     print('Ürün çekme hatası: ${response.error?.message}');
//     setState(() {
//       _errorMessage = 'Ürün bilgileri alınamadı: ${response.error?.message}';
//     });
//   } else if (response.productDetails.isEmpty) {
//     print('Ürün bulunamadı: ${productIds}');
//   }
...
//           setState(() => _purchasePending = false);
//           _showSnackBar('Satın alma sırasında bir hata oluştu: ${purchaseDetails.error?.message}', Colors.red);
//           break;
...
//     final product = _products.firstWhereOrNull((p) => p.id == _premiumUnlock);
//     final bool canPurchase = product != null && !_purchasePending && _available;
